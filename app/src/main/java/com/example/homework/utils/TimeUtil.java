...
public class TimeUtil {
    ...
    public static String toDateString(Calendar calendar){
        ...
        return calendar.get(Calendar.YEAR)+"年"
                +TimeUtil.format(calendar.get(Calendar.MONTH)+1)+"月"
    ...
    public static String timeTransfer(String i){
        ...
        if(tempDate < 0 || (tempDate ==0 && tempTime<0)){
            ...
            return mMonth+"月"+(Integer.valueOf(mDay)+tempDate)+"日"+timeSet.substring(0, 2)+":"+timeSet.substring(2, 4);
        }
    }

    public static Calendar getMinuteCreateTimeCalendar(){
        Calendar calendar = Calendar.getInstance();
        return calendar;
    }
